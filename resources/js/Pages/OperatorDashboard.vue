...
<template>
    ...
    <main class="min-h-screen w-full bg-blue-900 flex flex-col justify-center items-center py-12">
        ...
        <div class="flex flex-col items-center space-y-12">
            ...
            <Link v-if="$page.props.auth.user.id"  href="/new-partner" class="btn bg-red-600 text-white py-2 px-20 rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 text-center">Novi partner</Link>
            <!-- svi -->
