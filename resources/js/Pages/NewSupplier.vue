            ...
            <div class="bg-yellow-300 p-8 rounded-lg shadow">
                ...
                <form @submit.prevent="submitForm">
                    <div class="mb-4">
                        ...
                        <input v-model="form.name" id="naziv" name="naziv" type="text" class="mt-1 block w-full border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500">
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.oib" id="oib" name="oib" type="text" pattern="[0-9]{11}" class="mt-1 block w-full border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500">
                        <InputError class="mt-2" name="oib" :message="form.errors.oib" />
                    </div>

                    <div class="mb-4">
                        <label for="email" class="block text-sm font-medium text-gray-700">Email</label>
                        <input v-model="form.email" id="email" name="email" type="email" class="mt-1 block w-full border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500">
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.phone" id="telefon" name="telefon" type="tel" class="mt-1 block w-full border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500">
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.address" id="adresa" name="adresa" type="text" class="mt-1 block w-full border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="mjesto" v-model="form.city" name="mjesto" type="text" class="mt-1 block w-full border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500">
